...
def check_ffmpeg():
    try:
        ...
        logging.error("FFmpeg not found. Please install FFmpeg to compress video files.")
        ...
        print(f"Checked all {pathsChecked} available path strings and couldn't find ffmpeg.exe")
        return False
    ...
    if file_ext in ['jpg', 'jpeg', 'png']:
        ...
        try:
            with Image.open(file_path) as img:
                ...
                img.save(output_path, **{k: v for k, v in save_kwargs.items() if v is not None})
